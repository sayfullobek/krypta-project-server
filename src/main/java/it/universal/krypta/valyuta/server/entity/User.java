...
public class User extends AbsEntity implements UserDetails {
    ...
    public User(String firstName, String lastName, String email, String phoneNumber, String password, Gander gander, String referralCode, boolean agree, Role role, String status) {
